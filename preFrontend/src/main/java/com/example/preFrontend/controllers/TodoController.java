...
import com.example.preFrontend.models.TodoDto;
import com.example.preFrontend.security.DelegationAuthProvider;
import com.example.preFrontend.security.DelegationAuthToken;
...
public class TodoController {
    ...
    private WebClient getWebClient() throws GSSException {
        ...
        var authHeader = DelegationAuthProvider.createBackendToken(auth.getDelegationCredential(), backendSpn);
